...
function win(userChoice, computerChoice){
    ...
    result_p.innerHTML = `${cambiarPalabra(userChoice)} vence a ${cambiarPalabra(computerChoice)}. Ganaste!`;
...
function lose(userChoice, computerChoice){
    ...
    userScore_span.innerHTML = userScore;
    computerScore_span.innerHTML = computerScore;
    result_p.innerHTML = `${cambiarPalabra(userChoice)} pierde contra ${cambiarPalabra(computerChoice)}. Perdiste!`;
    const userChoice_div = document.getElementById(userChoice);
...
function draw(userChoice, computerChoice){
    userScore_span.innerHTML = userScore;
    computerScore_span.innerHTML = computerScore;
    result_p.innerHTML = `${cambiarPalabra(userChoice)} es igual a ${cambiarPalabra(computerChoice)}. Nadie gana!`;
    const userChoice_div = document.getElementById(userChoice);
